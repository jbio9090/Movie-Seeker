...
<form class="loginForm" method="POST" action="./register">
    ...
    <a href="<?php echo $this->params["googleAuthUrl"] ?>" class="loginWithGoogle">
        Login with Google
        <svg class="googleIcon"
            xmlns="http://www.w3.org/2000/svg" width="2443" height="2500" preserveAspectRatio="xMidYMid" viewBox="0 0 256 262" id="google">
